...
import PchainOrgPiBridgePchainorgPibridgeBlock from './pchain-org/pi-bridge/pchainorg.pibridge.block';
import PchainOrgPiBridgePchainorgPibridgeChain from './pchain-org/pi-bridge/pchainorg.pibridge.chain';
import PchainOrgPiBridgePchainorgPibridgeNode from './pchain-org/pi-bridge/pchainorg.pibridge.node';
import PchainOrgPiBridgePchainorgPibridgeProxy from './pchain-org/pi-bridge/pchainorg.pibridge.proxy';
import PchainOrgPiBridgePchainorgPibridgeTrx from './pchain-org/pi-bridge/pchainorg.pibridge.trx';
export default {
    ...
    PchainOrgPiBridgePchainorgPibridgeBlock: load(PchainOrgPiBridgePchainorgPibridgeBlock, 'pchainorg.pibridge.block'),
    PchainOrgPiBridgePchainorgPibridgeChain: load(PchainOrgPiBridgePchainorgPibridgeChain, 'pchainorg.pibridge.chain'),
    PchainOrgPiBridgePchainorgPibridgeNode: load(PchainOrgPiBridgePchainorgPibridgeNode, 'pchainorg.pibridge.node'),
    PchainOrgPiBridgePchainorgPibridgeProxy: load(PchainOrgPiBridgePchainorgPibridgeProxy, 'pchainorg.pibridge.proxy'),
    PchainOrgPiBridgePchainorgPibridgeTrx: load(PchainOrgPiBridgePchainorgPibridgeTrx, 'pchainorg.pibridge.trx'),
};
