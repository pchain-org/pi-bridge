declare const _default: {
    ...
    PchainOrgPiBridgePchainorgPibridgeBlock: (store: any) => void;
    PchainOrgPiBridgePchainorgPibridgeChain: (store: any) => void;
    PchainOrgPiBridgePchainorgPibridgeNode: (store: any) => void;
    PchainOrgPiBridgePchainorgPibridgeProxy: (store: any) => void;
    PchainOrgPiBridgePchainorgPibridgeTrx: (store: any) => void;
};
