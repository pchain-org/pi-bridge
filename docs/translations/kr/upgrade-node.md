...
최신 퍼블릭 테스트넷에 필요한 버전 정보를 확인하기 위해서는 [테스트넷 리포](https://github.com/cosmos/testnets)를 참고하시고, 각 릴리즈에 대한 자세한 정보는 [Pibridge 릴리즈 페이지](https://github.com/cosmos/Pibridge/releases)를 참고하세요.
