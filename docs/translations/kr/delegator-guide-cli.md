...
[**소스에서 설치하기**](https://cosmos.network/docs/pibridge/installation.html)
...
[풀노드를 운영하는 절차](https://cosmos.network/docs/pibridge/join-mainnet.html)와 [`gaiad`를 설치하는 방법](https://cosmos.network/docs/pibridge/installation.html)은 첨부된 링크를 확인하세요.
...
[`gaiad`](https://cosmos.network/docs/pibridge/gaiad.html)는 계정 잔고, 스테이킹 중인 토큰 수량, 지급 가능한 보상, 거버넌스 프로포절 등 블록체인과 관련된 모든 정보를 확인할 수 있게 합니다. 다음은 위임자에게 유용한 명령어들입니다. 다음 명령어를 실행하기 전 [gaiad 설정](#setting-up-gaiad)을 진행하세요.
