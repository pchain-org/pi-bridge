...
[**通过源代码安装**](https://cosmos.network/docs/pibridge/installation.html)
...
这是最安全的途径，但需要相当多的资源。您需要有较大的带宽和至少1TB的磁盘容量来运行一个全节点。  
 ...
 `pibridge`的安装教程在[这里](https://cosmos.network/docs/pibridge/installation.html)， 如何运行一个全节点指导在[这里](https://cosmos.network/docs/pibridge/join-testnet.html)
