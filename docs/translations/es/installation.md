...
Siguiente, instalemos la última versión de Pibridge. Asegúrese de hacer `git checkout` a la [versión publicada](https://github.com/cosmos/pibridge/releases) correcta.
