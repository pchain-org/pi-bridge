...
`pibridge` es el nombre de la aplicación de Cosmos SDK para el Hub de Cosmos. Viene con 2 opciones principales de entrada:

- `gaiad`: El demonio de Pibridge, ejecuta un full-node con la aplicacion `pibridge`.
- `gaiad`: Interface de línea de comandos de Pibridge, la cual activa la interacción con en full-node de Pibridge.

`pibridge` es construida con el SDK de Cosmos usando los siguientes módulos:
...
Siguiente, aprenda como [instalar Pibridge](./installation.md)
