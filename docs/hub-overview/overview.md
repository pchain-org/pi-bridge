...
In order to run a full-node for the Cosmos Hub mainnet, you must first [install `gaiad`](../pibridge-tutorials/installation.md). Then, follow [the guide](../pibridge-tutorials/join-mainnet.md).
