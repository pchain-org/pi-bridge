...
of Pibridge to use and details about the genesis file.
:::

::: warning
**You need to [install pibridge](./installation.md) before you go further**
:::
...
See the [testnet repo](https://github.com/cosmos/testnets) for details on which version is needed for which testnet, and the [Pibridge release page](https://github.com/cosmos/pibridge/releases) for details on each release.
