...
Right after Cosmos-SDK v0.31.0 is released, a Pibridge testnet will be released in
...
[cli]: https://github.com/cosmos/cosmos-sdk/blob/develop/docs/pibridge/delegator-guide-cli.md
