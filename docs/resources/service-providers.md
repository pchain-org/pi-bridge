...
First, you need to [install the software](../pibridge-tutorials/installation.md).

Consider running your own [Cosmos Hub Full Node](../pibridge-tutorials/join-mainnet.md).

## Command-Line Interface

The command-line interface (CLI) is the most powerful tool to access the Cosmos Hub and use pibridge.
To use the CLI, you must install the latest version of `pibridge` on your machine.

Compare your version with the [latest release version](https://github.com/cosmos/pibridge/releases)
...
Flags:
  -h, --help                help for gaiad
      --home string         directory for config and data (default "/Users/tobias/.pibridge")
...
When choosing to remote access a Full Node and gaiad, you need a Full Node running and pibridge installed on your local machine.
...
with your full node. Learn [how to enable the REST API](../pibridge-tutorials/join-mainnet.md#enable-the-rest-api) on your full node.
