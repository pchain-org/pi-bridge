...
Before setting up your validator node, make sure you've already gone through the [Full Node Setup](../pibridge-tutorials/join-mainnet.md) guide.
...
You may want to skip the next section if you have already [set up a full-node](../pibridge-tutorials/join-mainnet.md).
...
You should now see your validator in one of the Cosmos Hub explorers. You are looking for the `bech32` encoded `address` in the `~/.pibridge/config/priv_validator.json` file.
