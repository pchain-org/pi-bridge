...
import (
	...
	"github.com/pchain-org/pi-bridge/tools/blockchain/common/rlp"
...
func ConvertEHeaderToHeader(eheader types.Header) Header {
	var newHeader Header
	newHeader.ParentHash = eheader.ParentHash
	newHeader.UncleHash = eheader.UncleHash
	newHeader.Coinbase = eheader.Coinbase
	newHeader.Root = eheader.Root
	newHeader.TxHash = eheader.TxHash
	newHeader.ReceiptHash = eheader.ReceiptHash
	newHeader.Bloom = eheader.Bloom
	newHeader.Difficulty = eheader.Difficulty
	newHeader.Number = eheader.Number
	newHeader.GasLimit = eheader.GasLimit
	newHeader.GasUsed = eheader.GasUsed
	newHeader.Time = eheader.Time
